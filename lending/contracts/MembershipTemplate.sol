...
contract MembershipTemplate is  BaseTemplate, TokenCache {
    ...
    */
        ...
        external returns(Vault)
    {
        ...
        (,,Vault vault) = newInstance(_id, _members, _votingSettings, _financePeriod, _useAgentAsVault);
        return (vault);
    }
    ...
    */
    function newInstance(
        ...
        public returns(Finance,Voting,Vault)
  {
        _validateId(_id);
        _ensureMembershipSettings(_members, _votingSettings);

        (Kernel dao, ACL acl) = _createDAO();
        (Finance finance, Voting voting, Vault vault) = _setupApps(dao, acl, _members, _votingSettings, _financePeriod, _useAgentAsVault);
    ...
    */
        ...
        returns (Finance, Voting, Vault)
    {
        ...
        return (finance, voting, agentOrVault);
    }
